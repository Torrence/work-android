...
<table width="780" height="110" border="0" align="center" cellpadding="0" cellspacing="0" background="images/bodybg.jpg">
  <tr>
    <td width="100" height="94" rowspan="2"><img src="images/logo_new.gif" width="120" height="94" align="right"></td>
	
    <td width="577" height="65"><div align="center"><font size="+2" color="#CC6600"><b>商业拍卖Java EE程序框架</b></font></div></td>
    <td width="103" rowspan="2"><img src="images/logo_new.gif" width="120" height="94"></td>
  </tr>
  <tr>
    <td height="15"><div align="center" class="title">如果需要开发高档的Java EE应用，请联系<a href="mailto:cwq@127.0.0.1">cwq@127.0.0.1</a>。谢谢</div></td>
  </tr>
  <tr>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="68" background="images/bodybg.jpg">   <div align="center" class="pt9">
      ...
      版权所有 Copyright@2006 Wenqing Chu <BR>
    如有任何问题和建议，<A href="mailto:cwq@127.0.0.1">请E-mail to me</A>！<BR>
