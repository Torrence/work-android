...
public class OAuthV2ImplicitGrantActivity extends Activity {
    ...
    private String redirectUri="http://hi.baidu.com/new/liumeng1201";                   
    //!!!请根据您的实际情况修改!!!      换为您为自己的应用申请到的APP KEY
    private String clientId = "801107040"; 
    //!!!请根据您的实际情况修改!!!      换为您为自己的应用申请到的APP SECRET
    private String clientSecret="2a39f50e93aa7b1358f8eccee595bf06";
