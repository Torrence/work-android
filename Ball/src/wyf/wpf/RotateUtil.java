...
public class RotateUtil{			
	...
	public static int getDirectionCase(double[] values){
		double zAngle=Math.toRadians(values[2]);//获取z轴旋转角度弧度-0
		double xAngle=-Math.toRadians(values[1]);//获取x轴旋转角度弧度-1
		double yAngle=Math.toRadians(values[0]);//获取y轴旋转角度弧度-2
		/*
