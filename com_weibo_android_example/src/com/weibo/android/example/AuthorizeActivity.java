...
public class AuthorizeActivity extends Activity {
	...
	private static final String CONSUMER_KEY = "1208013166";// 替换为开发者的appkey，例如"1646212960";
	private static final String CONSUMER_SECRET = "8d093c21782fa9942870ed99326869bd";// 替换为开发者的appkey，例如"94098772160b6f8ffc1315374d8861f9";
		...
		mLogin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (v == mLogin) {
					...
					// Oauth2.0
					// 隐式授权认证方式
					weibo.setRedirectUrl("http://hi.baidu.com/new/liumeng1201");// 此处回调页内容应该替换为与appkey对应的应用回调页
